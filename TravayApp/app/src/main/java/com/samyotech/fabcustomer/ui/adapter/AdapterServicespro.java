...
import com.samyotech.fabcustomer.ui.fragment.Services;
...
public class AdapterServicespro extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterServicespro(Services services, ArrayList<ProductDTO> productDTOList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == TYPE_CAMERA) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_services_pro, parent, false);
