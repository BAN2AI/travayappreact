...
import com.samyotech.fabcustomer.ui.fragment.AppliedJobsFrag;
...
public class AppliedJobAdapterPro extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public AppliedJobAdapterPro(AppliedJobsFrag appliedJobsFrag, ArrayList<AppliedJobDTO> objects, UserDTO userDTO, LayoutInflater inflater) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_applied_job_pro, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holderMain, @SuppressLint("RecyclerView") final int position) {
        if (holderMain instanceof MyViewHolder) {
            ...
            holder.tvMobile.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (ProjectUtils.hasPermissionInManifest((Activity) mContext, CALL_PERMISSION, Manifest.permission.CALL_PHONE)) {
