...
import com.samyotech.fabcustomer.Explore;
...
import com.samyotech.fabcustomer.ui.fragment.AllJobsFrag;
import com.samyotech.fabcustomer.ui.fragment.AppointmentFrag;
import com.samyotech.fabcustomer.ui.fragment.ChatList;
import com.samyotech.fabcustomer.ui.fragment.DiscoverFragment;
...
public class BaseActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public ImageView menuLeftIV, ivFilter, ivSearch;
...
//        bottomNavigationView = findViewById(R.id.botom_nav);
        integerDeque.push(R.id.home_menu);
...
//        mainframe = (FrameLayout) findViewById(R.id.frame_main);
        ...
        spaceNavigationView.addSpaceItem(new SpaceItem("Discover", R.drawable.ic_explore));
        spaceNavigationView.addSpaceItem(new SpaceItem("Jobs", R.drawable.ic_jobs_menu));
        spaceNavigationView.addSpaceItem(new SpaceItem("Notifications", R.drawable.ic_notifications));
        spaceNavigationView.addSpaceItem(new SpaceItem("Profile", R.drawable.ic_users_profile));
        spaceNavigationView.showIconOnly();

        UpgradBtn = (Button) findViewById(R.id.footer_item_1);
        UpgradBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(mContext, UpgradeAccount.class);
...
//                    System.out.println("menu cliecked");
//
//                    CURRENT_TAG = TAG_MAIN;
//                    loadHomeFragment(new DiscoverFragment(), CURRENT_TAG);
////                    getSupportFragmentManager()
////                            .beginTransaction()
////                            .replace(R.id.frame_main, new DiscoverFragment(), new Explore().getClass().getSimpleName())
////                            .commit();
//
...
////                    getSupportFragmentManager()
////                            .beginTransaction()
////                            .replace(R.id.frame_main, new AllJobsFrag(), new AllJobsFrag().getClass().getSimpleName())
////                            .commit();
//
//                } else if (id == R.id.notification_menu) {
//                    System.out.println("map cliecked");
//                    CURRENT_TAG = TAG_NOTIFICATION;
//                    loadHomeFragment(new NotificationActivity(), CURRENT_TAG);
////                    getSupportFragmentManager()
////                            .beginTransaction()
////                            .replace(R.id.frame_main, new NotificationActivity(), new NotificationActivity().getClass().getSimpleName())
////                            .commit();
//
//                } else if (id == R.id.profile_menu) {
//                    System.out.println("profile cliecked");
//                    CURRENT_TAG = TAG_PROFILE_SETINGS;
//                    loadHomeFragment(new ProfileSettingActivity(), CURRENT_TAG);
////                    getSupportFragmentManager()
////                            .beginTransaction()
////                            .replace(R.id.frame_main, new ProfileSettingActivity(), new ProfileSettingActivity().getClass().getSimpleName())
////                            .commit();
//                }
//            }
//        });
...
//                fragmentTransaction.replace(R.id.frame_main, new ProfileSettingActivity());
...
//        });
        spaceNavigationView.setSpaceOnClickListener(new SpaceOnClickListener() {
            ...
            public void onCentreButtonClick() {
                Intent intent = new Intent(mContext, PostJob.class);
                startActivity(intent);
...
//                    bottomNavigationView.getMenu().getItem(0).setChecked(true);
                    ...
                    CURRENT_TAG = TAG_JOBS;
                    loadHomeFragment(new AllJobsFrag(), CURRENT_TAG);
...
//                            .commit();
    ...
    public void applyCustomFont(MenuItem mi) {
        Typeface customFont = FontCache.getTypeface("Nunito-Regular.ttf", BaseActivity.this);
    ...
    private void loadHomeFragment(final Fragment fragment, final String TAG) {
        ...
        Runnable mPendingRunnable = new Runnable() {
            ...
            public void run() {
                ...
                fragmentTransaction.commitAllowingStateLoss();
//                fragment.getView().setLayoutParams(new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (ViewGroup.LayoutParams.WRAP_CONTENT * 0.6)));
                ivFilter.setVisibility(View.VISIBLE);
...
//                        fragmentTransaction.replace(R.id.frame_main, new Home());
                        loadHomeFragment(new DiscoverFragment(), CURRENT_TAG);
                        break;
                    case R.id.nav_chat:
                        ivFilter.setVisibility(View.GONE);
                        ...
                        loadHomeFragment(new ChatList(), CURRENT_TAG);
//                        fragmentTransaction.replace(R.id.frame_main, new ChatList());
                        break;
                    case R.id.nav_booking:
                        ivFilter.setVisibility(View.GONE);
                        navItemIndex = 2;
                        CURRENT_TAG = TAG_BOOKING;
//                        fragmentTransaction.replace(R.id.frame_main, new MyBooking());
                    ...
                    case R.id.nav_jobs:
                        ...
                        navItemIndex = 3;
                        CURRENT_TAG = TAG_JOBS;
//                        fragmentTransaction.replace(R.id.frame_main, new Jobs());
                        Intent intent = new Intent(mContext, PostJob.class);
                        startActivity(intent);
                        break;
...
//                        fragmentTransaction.replace(R.id.frame_main, new AppointmentFrag());
                        loadHomeFragment(new AppointmentFrag(), CURRENT_TAG);
                        break;
//                    case R.id.nav_notification:
//                        ivFilter.setVisibility(View.GONE);
//                        navItemIndex = 5;
//                        CURRENT_TAG = TAG_NOTIFICATION;
//                        fragmentTransaction.replace(R.id.frame_main, new NotificationActivity());
//                        break;
                    case R.id.nav_history:
                        ivFilter.setVisibility(View.GONE);
                        navItemIndex = 6;
                        CURRENT_TAG = TAG_DISCOUNT;
                        fragmentTransaction.replace(R.id.frame_main, new HistoryFragment());
                        break;
                    case R.id.nav_discount:
                        ivFilter.setVisibility(View.GONE);
                        navItemIndex = 7;
                        CURRENT_TAG = TAG_HISTORY;
//                        fragmentTransaction.replace(R.id.frame_main, new GetDiscountActivity());
                        loadHomeFragment(new GetDiscountActivity(), CURRENT_TAG);
                        break;
                    case R.id.nav_wallet:
                        ivFilter.setVisibility(View.GONE);
                        navItemIndex = 8;
                        CURRENT_TAG = TAG_WALLET;
//                        fragmentTransaction.replace(R.id.frame_main, new Wallet());
                        loadHomeFragment(new Wallet(), CURRENT_TAG);
                        break;
...
//                        fragmentTransaction.replace(R.id.frame_main, new ProfileSettingActivity());
                    ...
                    case R.id.nav_tickets:
                        ...
                        CURRENT_TAG = TAG_TICKETS;
                        ivFilter.setVisibility(View.GONE);
//                        fragmentTransaction.replace(R.id.frame_main, new Tickets());
                        loadHomeFragment(new Tickets(), CURRENT_TAG);
                        break;
                    default:
                        ivFilter.setVisibility(View.VISIBLE);
                        navItemIndex = 0;
                        CURRENT_TAG = TAG_MAIN;
                        fragmentTransaction.replace(R.id.frame_main, new DiscoverFragment());
                        break;
