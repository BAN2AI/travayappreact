...
import com.samyotech.fabcustomer.ui.fragment.ArtistProfilePro;
import com.samyotech.fabcustomer.ui.fragment.ChatList;
import com.samyotech.fabcustomer.ui.fragment.CustomerBooking;
import com.samyotech.fabcustomer.ui.fragment.HistoryFragment;
import com.samyotech.fabcustomer.ui.fragment.JobsFrag;
import com.samyotech.fabcustomer.ui.fragment.MyEarning;
import com.samyotech.fabcustomer.ui.fragment.NewBookings;
import com.samyotech.fabcustomer.ui.fragment.Notification;
import com.samyotech.fabcustomer.ui.fragment.ProfileSetting;
...
public class BaseActivity1 extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        LocationListener {
    private String TAG = BaseActivity1.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_base_pro);
        mContext = BaseActivity1.this;
        ...
        llProfileClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.frame, new ArtistProfilePro());
    ...
    protected void onResume() {
        ...
        if (userDTO.getIs_profile() == 1) {
            if (userDTO.getApproval_status_int() == 0) {
                getApproveStatus();
            }
        }
    }
    ...
    public void applyCustomFont(MenuItem mi) {
        Typeface customFont = FontCache.getTypeface("Nunito-Regular.ttf", BaseActivity1.this);
    ...
    private void getMyLocation() {
        if (googleApiClient != null) {
            if (googleApiClient.isConnected()) {
                int permissionLocation = ContextCompat.checkSelfPermission(BaseActivity1.this,
                            ...
                            switch (status.getStatusCode()) {
                                case LocationSettingsStatusCodes.SUCCESS:
                                    ...
                                    int permissionLocation = ContextCompat
                                            .checkSelfPermission(BaseActivity1.this,
                                                    Manifest.permission.ACCESS_FINE_LOCATION);
                                    if (permissionLocation == PackageManager.PERMISSION_GRANTED) {
                                ...
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        status.startResolutionForResult(BaseActivity1.this,
    ...
    private void checkPermissions() {
        ...
        if (permissionLocation != PackageManager.PERMISSION_GRANTED) {
            ...
            if (!listPermissionsNeeded.isEmpty()) {
                ActivityCompat.requestPermissions(BaseActivity1.this,
    ...
    private synchronized void setUpGClient() {
        googleApiClient = new GoogleApiClient.Builder(BaseActivity1.this)
                .enableAutoManage(BaseActivity1.this, 0, this)
    ...
    public void language(String language) {
        ...
        BaseActivity1.this.getResources().updateConfiguration(config,
                BaseActivity1.this.getResources().getDisplayMetrics());
            ...
            public void backResponse(boolean flag, String msg, JSONObject response) {
                if (flag) {
                    try {
                        ...
                        userDTO.setApproval_status_int(approval_status);
