...
import com.samyotech.fabcustomer.databinding.ActivityAppIntro2Binding;
...
public class AppIntro extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    int[] mResources = {R.drawable.splashintro3, R.drawable.splashintro2, R.drawable.splahintro1};
