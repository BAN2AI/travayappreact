...
import com.samyotech.fabcustomer.databinding.DailogArProductBinding;
...
import com.samyotech.fabcustomer.ui.adapter.AdapterServices;
import com.samyotech.fabcustomer.ui.adapter.AdapterServicespro;
...
public class Services extends Fragment {
    ...
    private AdapterServicespro adapterServices;
    private Bundle bundle;
    private GridLayoutManager gridLayoutManager;
    private RelativeLayout rlView;
    private CustomTextViewBold tvNotFound;
    private ArtistProfilePro parentFrag;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentFrag = ((ArtistProfilePro) Services.this.getParentFragment());
    ...
    public void showData() {
        ...
        if (productDTOList.size() > 0) {
            ...
            adapterServices = new AdapterServicespro(Services.this, productDTOList);
