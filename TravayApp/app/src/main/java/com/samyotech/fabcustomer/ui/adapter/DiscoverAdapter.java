...
import com.samyotech.fabcustomer.ui.activity.ArtistProfile;
...
//            holder.CTVtime.setText(ProjectUtils.getDisplayableTime(ProjectUtils.correctTimestamp(Long.parseLong(allAtristListDTOList.get(position).getCreated_at()))));
        ...
        holder.tvdescription.setText(allAtristListDTOList.get(position).getAbout_us());
...
//        holder.ratingbar.setRating(Float.parseFloat(allAtristListDTOList.get(position).getAva_rating()));
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomTextViewBold CTVartistname, CTVartistchargeprh, CTVjobdone, CTVlocation;
        public CustomTextView CTVartistwork,  CTVpersuccess,  CTVdistance, CTVtime, tvRating, tvdescription;
        ...
        public MyViewHolder(View view) {
            ...
            CTVjobdone = view.findViewById(R.id.tvJobDone);
            tvdescription = view.findViewById(R.id.CTVartistDescription);
//            CTVpersuccess = view.findViewById(R.id.tvpersuccess);
