...
public class UserDTO implements Serializable {
    ...
    public int getApproval_status_int() {

        return approval_status_int;
    }

    public int setApproval_status_int(int approval_status) {

        return this.approval_status_int = approval_status;
    }
    ...
    public  String getType_user(){return this.type_user;}
}
